...
@section('title', 'Post Analytics - Ink & Paper')
...
<span class="bg-surface-container-high text-on-surface-variant px-3 py-1 rounded-full text-metadata font-metadata uppercase tracking-wider">Published</span>
<span class="text-secondary text-metadata font-metadata">Oct 12, 2023</span>
</div>
<h1 class="font-display-lg text-display-lg-mobile md:text-display-lg text-on-surface leading-tight">The Art of Digital Silence: Minimalism in a Wired World</h1>
</div>
<div class="flex gap-4">
<button class="px-6 py-2 border border-outline text-on-surface font-ui-button text-ui-button rounded-lg hover:bg-surface-container transition-all">Edit Post</button>
<button class="px-6 py-2 bg-on-surface text-surface font-ui-button text-ui-button rounded-lg hover:opacity-90 transition-all">View Live</button>
</div>
</div>
</div>
<!-- Hero Metrics -->
...
<p class="text-secondary font-metadata text-metadata">Percentage of users who reached each section</p>
</div>
...
<span class="material-symbols-outlined text-6xl text-primary" data-weight="fill">sentiment_very_satisfied</span>
...
<p class="mt-6 text-secondary text-metadata font-metadata italic leading-relaxed">
                        "Most readers appreciate the practical advice on digital detoxing, though some requested more specific app recommendations."
                    </p>
</div>
<!-- Audience Geography -->
<div class="bg-surface-container-lowest border border-outline-variant p-8 rounded-xl">
