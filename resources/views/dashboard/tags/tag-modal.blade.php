<!-- Create Tag Modal -->
<div
    class="relative bg-surface-container-lowest w-full max-w-md border border-outline-variant/30 rounded-xl custom-shadow z-50 overflow-hidden transform transition-all">
    <!-- Header -->
    ...
    <!-- Form Content -->
    <form method="POST" action="{{ route('pos') }}" class="p-6 space-y-6">
        <!-- Tag Name Input -->
        <div class="space-y-2">
            ...
            <div class="relative">
                ...
                <input
                    ...
                    id="tag-name" placeholder="AI" type="text" />
            </div>
        </div>
        ...
        <div class="space-y-2">
            ...
            <textarea
                ...
                id="tag-description" placeholder="Briefly describe the theme of this tag..." rows="3"></textarea>
        </div>
        {{-- <!-- Featured Toggle -->
        <div class="flex items-center justify-between py-2">
            <div class="space-y-0.5">
                <p class="font-ui-label text-ui-label text-on-surface">Featured Tag</p>
                <p class="font-metadata text-metadata text-on-surface-variant">Promote this tag on the exploration feed
                </p>
            </div>
    ...
    <div class="bg-surface-container-low px-6 py-4 border-t border-outline-variant/20">
        <div class="flex items-center gap-3">
            ...
            <p class="font-metadata text-metadata text-on-surface-variant">
                Tags help <span class="font-medium text-on-surface">creators</span> organize intellectual content and
                improve discovery in the digital quiet.
            </p>
        </div>
    </div>
</div>
