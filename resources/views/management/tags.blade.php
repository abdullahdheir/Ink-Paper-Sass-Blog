...
<p class="font-ui-label text-ui-label text-on-secondary-container">Organize, track, and optimize the discovery of your editorial content.</p>
</div>
<div class="flex flex-col sm:flex-row items-center gap-4">
<div class="relative w-full sm:w-72">
<span class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline">search</span>
<input class="w-full pl-10 pr-4 py-2 bg-surface-container-lowest border border-outline-variant rounded-lg focus:border-primary focus:ring-1 focus:ring-primary outline-none font-ui-label text-ui-label" placeholder="Search tags..." type="text"/>
</div>
<button class="w-full sm:w-auto font-ui-button text-ui-button px-6 py-2.5 bg-primary-container text-on-primary-container rounded-lg hover:brightness-110 transition-all flex items-center justify-center gap-2">
...
<!-- Card 1 -->
<div class="bg-surface-container-lowest border border-outline-variant p-6 rounded-lg hover:shadow-lg transition-all duration-300">
<div class="flex justify-between items-start mb-8">
<div>
<span class="font-metadata text-metadata uppercase tracking-wider text-primary mb-1 block">Trending Now</span>
...
<div class="flex justify-between items-start mb-8">
<div>
<span class="font-metadata text-metadata uppercase tracking-wider text-secondary mb-1 block">Steady Performance</span>
...
<div class="flex justify-between items-start mb-8">
<div>
<span class="font-metadata text-metadata uppercase tracking-wider text-primary-fixed-dim mb-1 block">Spotlight</span>
...
<!-- Decorative Element -->
<div class="absolute -right-12 -bottom-12 w-48 h-48 bg-on-primary-fixed-variant rounded-full opacity-20"></div>
</div>
</div>
</section>
<!-- All Tags Section -->
...
<th class="px-6 py-4 font-ui-label text-ui-label font-bold text-on-surface text-right">Actions</th>
</tr>
</thead>
...
<td class="px-6 py-4">
<span class="px-2 py-1 rounded-full bg-primary-fixed text-on-primary-fixed font-metadata text-[10px] font-bold uppercase tracking-widest">Trending</span>
</td>
...
<td class="px-6 py-4">
<span class="px-2 py-1 rounded-full bg-surface-container-high text-on-surface-variant font-metadata text-[10px] font-bold uppercase tracking-widest">Active</span>
</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-3 opacity-0 group-hover:opacity-100 transition-opacity">
<button class="p-1 hover:text-primary transition-colors"><span class="material-symbols-outlined text-[20px]">edit</span></button>
...
<button class="font-ui-label text-ui-label text-secondary hover:text-primary transition-colors flex items-center gap-2">
<span class="material-symbols-outlined text-[18px]">chevron_left</span>
                        Previous
                    </button>
<div class="flex gap-2">
<span class="w-8 h-8 flex items-center justify-center rounded bg-primary text-on-primary font-ui-label text-ui-label">1</span>
<span class="w-8 h-8 flex items-center justify-center rounded hover:bg-surface-container transition-colors cursor-pointer font-ui-label text-ui-label">2</span>
<span class="w-8 h-8 flex items-center justify-center rounded hover:bg-surface-container transition-colors cursor-pointer font-ui-label text-ui-label">3</span>
</div>
<button class="font-ui-label text-ui-label text-secondary hover:text-primary transition-colors flex items-center gap-2">
                        Next
