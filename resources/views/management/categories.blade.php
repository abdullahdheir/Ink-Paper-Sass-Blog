...
<button class="bg-primary text-on-primary px-6 py-3 rounded-lg font-ui-button text-ui-button shadow-sm hover:opacity-90 active:scale-95 transition-all flex items-center gap-2 whitespace-nowrap">
...
<button class="p-2 hover:bg-surface-variant rounded transition-colors text-on-surface-variant" title="Edit">
<span class="material-symbols-outlined">edit</span>
</button>
<button class="p-2 hover:bg-surface-variant rounded transition-colors text-on-surface-variant" title="Archive">
...
<img alt="Author 1" class="w-8 h-8 rounded-full border-2 border-white" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAM9W2eat990-MVuNeIYffYl4uCTjTXoTDfCkm5YnoYgLGGNItf3ZFWbIiI4zlndiQrKTpdrxEGvYPWzKXLlQjL4wehIr42eJOSPixKXqeXoC_V4Z1_aF_KwtpRsbbO0d44KWWjd7HzAcTDucldNYNk4uENBOPiawr5b7k3Bu8H23jXPWJ9cTTe7tUVE59NUNvop508ThgZtWAQEJpIRLtOn6sR3fnH1kiu27bo1DSwMu-hI32iO6u4hysa1hj9C-za6Iyt2s_SmU5P"/>
<img alt="Author 2" class="w-8 h-8 rounded-full border-2 border-white" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAKPJgbkFGxKR0m2d-FErVkoDZOyPahRJUhk38XNvW-COCnYhQuHoUpWWzxZlx4Yw_MKRQv-hBWa7wJnzmnsEnzxxiEDlo8D6Nix9Dz86IkszKqGvpPnmKWEIPfpwRItcrXviKGnvHoTOgsiwyZ2q0eY4Y39ASefgoNHJQ8V216woNYM9USWNth_kx-qF-Ce4EHb-zJwJjmz2CCPwcJOYLZkVHmc3Gier99MXbC6G-k7YbskMfc25a8mBGo_4ZvZptyzFASnYistu5l"/>
<img alt="Author 3" class="w-8 h-8 rounded-full border-2 border-white" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDiwTDaFlut3XFfRu1Q1m515KiFGoWnhCSo3OXJnC4SmXhP1YJGFBVII95SR0vkGagyqbj-PyeyJgGOkKt3NRE3YyO6CFZaF58p_bbwT8jHeW3A9CmlBr_Eyw2PU_Urg9DfRSJXpCcoAzCykr9ChjXiu32mZOSgGyqC-saZTPO6M0RsV-M2oID969jcz852HptuijLLHM6B81bOv1K452v_0fvyhmrk-rOUvuOYsTeLOwFt0omuRE-AFNxA22JFM-z5JfdFkJp1fB-m"/>
<div class="w-8 h-8 rounded-full bg-surface-container border-2 border-white flex items-center justify-center font-metadata text-metadata">+8</div>
</div>
</div>
</div>
</div>
...
<p class="font-body-md text-on-surface-variant text-base mb-6">Visual culture, UI patterns, and typography systems.</p>
</div>
<div>
...
<p class="font-body-md text-on-surface-variant text-base mb-6">The art of subtraction and intentional living in the digital age.</p>
</div>
...
<p class="font-body-md text-on-surface-variant text-base mb-6">Structural beauty and urban planning philosophy.</p>
</div>
<div class="flex items-center gap-6">
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-on-surface-variant text-sm">article</span>
...
<div class="font-metadata text-metadata text-on-surface-variant">/categories/design-systems</div>
</td>
<td class="px-6 py-4">
...
<div class="font-metadata text-metadata text-on-surface-variant">/categories/interface-trends</div>
</td>
<td class="px-6 py-4">
<span class="px-2 py-1 bg-green-100 text-green-800 rounded text-xs font-bold">Active</span>
</td>
...
<div class="font-metadata text-metadata text-on-surface-variant">/categories/web3-explorations</div>
</td>
<td class="px-6 py-4">
<span class="px-2 py-1 bg-surface-container-highest text-secondary rounded text-xs font-bold">Archived</span>
</td>
<td class="px-6 py-4 font-ui-label text-ui-label">3</td>
<td class="px-6 py-4 font-ui-label text-ui-label">402</td>
<td class="px-6 py-4 text-right">
<div class="flex justify-end gap-2">
<button class="text-on-surface-variant hover:text-primary"><span class="material-symbols-outlined">unarchive</span></button>
<button class="text-on-surface-variant hover:text-error"><span class="material-symbols-outlined">delete</span></button>
</div>
</td>
</tr>
