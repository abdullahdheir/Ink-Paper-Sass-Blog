    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    <div>
                        <p class="font-metadata text-metadata text-on-surface-variant uppercase mb-1">Articles</p>
        ...
        <div
            ...
            <div>
                ...
                <p class="font-body-md text-on-surface-variant text-base mb-6">Visual culture, UI patterns, and typography
                    systems.</p>
            </div>
            <div>
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex flex-col items-end">
                        <span class="font-metadata text-metadata text-on-surface-variant uppercase">Articles</span>
        ...
        <div
            ...
            <div>
                ...
                <p class="font-body-md text-on-surface-variant text-base mb-6">The art of subtraction and intentional living
                ...
                <tbody class="divide-y divide-outline-variant">
                    <tr class="hover:bg-surface transition-colors">
                        <td class="px-6 py-4">
                            ...
                            <div class="font-metadata text-metadata text-on-surface-variant">/categories/design-systems
                            </div>
                        </td>
                        <td class="px-6 py-4">
                    ...
                    <tr class="hover:bg-surface transition-colors">
                        <td class="px-6 py-4">
                            ...
                            <div class="font-metadata text-metadata text-on-surface-variant">/categories/interface-trends
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 bg-green-100 text-green-800 rounded text-xs font-bold">Active</span>
                    ...
                    <tr class="hover:bg-surface transition-colors">
                        <td class="px-6 py-4 opacity-50">
                            ...
                            <div class="font-metadata text-metadata text-on-surface-variant">/categories/web3-explorations
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span
