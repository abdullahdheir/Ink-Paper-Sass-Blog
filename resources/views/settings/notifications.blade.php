...
<div class="space-y-6">
    ...
    <div class="bg-surface border border-outline-variant rounded-2xl p-6">
        ...
        <p class="font-body-md text-body-md text-secondary">Manage how and when you receive updates from authors and the platform.</p>
    </div>
    ...
    <form class="space-y-6">
        ...
        <div class="bg-surface border border-outline-variant rounded-2xl p-6">
            ...
            <div class="divide-y divide-outline-variant">
                @php
                $emailItems = [
                    ['label' => 'New articles from followed authors', 'desc' => 'Get notified immediately when your favorite writers publish.', 'checked' => true],
                    ['label' => 'Weekly digest', 'desc' => 'A curated summary of the best stories from the past week.', 'checked' => true],
                    ['label' => 'New followers', 'desc' => 'Know as soon as someone follows your work.', 'checked' => false],
                    ['label' => 'Mentions in comments', 'desc' => 'When someone tags you in a discussion.', 'checked' => true],
                ];
                @endphp
                ...
                <div class="flex items-center justify-between py-4 first:pt-0 last:pb-0">
                    <div>
                        <p class="font-ui-label text-ui-label font-semibold text-on-surface">{{ $item['label'] }}</p>
        ...
        <div class="bg-surface border border-outline-variant rounded-2xl p-6">
            <div class="flex items-center gap-3 mb-5 pb-4 border-b border-outline-variant">
                <div class="w-9 h-9 rounded-xl bg-primary-container/15 flex items-center justify-center">
                    <span class="material-symbols-outlined text-primary text-[20px]" style="font-variation-settings: 'FILL' 1;">phonelink_ring</span>
                </div>
                <div>
            ...
            <div class="divide-y divide-outline-variant">
                @php
                $pushItems = [
                    ['label' => 'Activity on my posts', 'desc' => 'Likes, highlights, and comments on your published work.', 'checked' => true],
                    ['label' => 'Direct messages', 'desc' => 'Instant alerts for private conversations.', 'checked' => true],
                ];
                @endphp
        ...
        <div class="bg-surface border border-outline-variant rounded-2xl p-6">
            <div class="flex items-center gap-3 mb-5 pb-4 border-b border-outline-variant">
                <div class="w-9 h-9 rounded-xl bg-primary-container/15 flex items-center justify-center">
                    <span class="material-symbols-outlined text-primary text-[20px]" style="font-variation-settings: 'FILL' 1;">campaign</span>
                </div>
                <div>
            ...
            <div class="divide-y divide-outline-variant">
                @php
                $marketingItems = [
                    ['label' => 'Platform updates', 'desc' => 'Major new feature releases and community announcements.', 'checked' => false],
                    ['label' => 'Special offers', 'desc' => 'Discounts on premium memberships and workshop access.', 'checked' => false],
                ];
                @endphp
