...
@section('page-content')
    <div class="max-w-container-max mx-auto px-gutter">
        ...
        <section class="flex flex-col md:flex-row gap-12 items-start mb-16">
            ...
            <div class="flex-1 space-y-6">
                <div>
                    ...
                    <p class="font-body-lg text-body-lg text-on-surface-variant max-w-article-max">Critical thinker, system
                        architect, and full-stack storyteller. Exploring the intersection of human psychology and
                ...
                <div class="flex gap-4 pt-4 border-t border-outline-variant">
                    <button
                        ...
                        Author</button>
                    <button
                        class="border border-on-surface text-on-surface px-8 py-3 rounded-lg font-ui-button text-ui-button hover:bg-surface-container transition-all">Share
                        Profile</button>
                </div>
            </div>
        </section>
        ...
        <div class="space-y-12">
            ...
            <article class="flex flex-col md:flex-row gap-8 items-start group">
                ...
                <div class="flex-1 space-y-4">
                    <div class="flex items-center gap-3">
                        <span
                            class="bg-primary-fixed text-on-primary-fixed px-3 py-1 rounded-full font-metadata text-metadata uppercase tracking-widest">Technology</span>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant line-clamp-3">In an era where abstraction
                        layers are thicker than ever, understanding the fundamental physics of software remains the only
                        true competitive advantage for developers. We explore the hidden costs of convenience...</p>
                    <div class="flex items-center gap-6 pt-2">
                        <button
                            class="flex items-center gap-2 font-ui-label text-ui-label text-secondary hover:text-on-surface">
            ...
            <article class="flex flex-col md:flex-row gap-8 items-start group">
                <div
                    class="w-full md:w-80 h-52 shrink-0 overflow-hidden rounded-lg border border-outline-variant bg-surface-container-low">
                    <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                        data-alt="A minimalist composition of open, cream-colored notebooks and vintage fountain pens resting on a dark walnut desk. The scene is illuminated by harsh, direct sunlight from a window, creating dramatic sharp shadows and deep ink-like contrasts. The aesthetic is purely editorial and intellectual, emphasizing the act of writing and deep thinking on high-quality paper."
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuCkyB2zWJPPrtsMq3DyIiD37NgudJrqsdBSftSl32tPuJGx2ZhSlaX_EzSItl_o6tYamHjPqSCoJhd3FaPsYRB62Z0Eq5QsVGKjzmDKpTKLMRY1tObib06BAvm87IrSArk1DV8KpNANiskh4MB9-azYC8OZLKIoxB8LK77vxbo-oBQTDq7UIu6zKNJGM7cPl4rWO3ztjYJM6vMmiDODzh4ppETD2LGifKjzIJP4CwtVUS83eoOIVwLadRckFWFQEjnT2JNpDWMqWXfk" />
                </div>
                <div class="flex-1 space-y-4">
                    <div class="flex items-center gap-3">
                        <span
                            class="bg-primary-fixed text-on-primary-fixed px-3 py-1 rounded-full font-metadata text-metadata uppercase tracking-widest">Philosophy</span>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant line-clamp-3">The attention economy has
                        fractured our ability to sit with a single problem for more than ten minutes. By revisiting the
                        rituals of Leibniz and Von Neumann, we can reclaim our intellectual autonomy...</p>
                    <div class="flex items-center gap-6 pt-2">
                        <button
                            class="flex items-center gap-2 font-ui-label text-ui-label text-secondary hover:text-on-surface">
            ...
            <article class="flex flex-col md:flex-row gap-8 items-start group">
                <div
                    class="w-full md:w-80 h-52 shrink-0 overflow-hidden rounded-lg border border-outline-variant bg-surface-container-low">
                    <img class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105"
                        data-alt="A digital render of a decentralized network visualization, featuring intricate nodes and crystalline structures connected by thin vibrant violet threads. The background is a deep charcoal void, making the white and purple connections stand out with intense clarity. The style is sharp, clean, and representative of modern blockchain and cryptography concepts with a high-end SaaS aesthetic."
                        src="https://lh3.googleusercontent.com/aida-public/AB6AXuA2Gu-dRx1DuzQgocCs5yUAkoWTxR4v7wwgWxdH3DaEaPcSsx0M_nuPnVHwkrv9sGwF0sTFu1SsyK-uHYPeiH5jXOLcdd1Fv7oKqdVG4wdNnwZSzHn3FdW_nXHXOEAs_R8cu2DIZZsnFnIDTijaqTpkbhue-dCS30rb239dZWwZ4lWnX99XI2Tzh5J54BMUhczwjmqsvON7PgZagLPd0WEPat_I_rL1QVlzRYpbi4i9VFSVIBFLGDliakELNDx3yyEBN_hNuAR-57NR" />
                </div>
                <div class="flex-1 space-y-4">
                    <div class="flex items-center gap-3">
                        <span
                            class="bg-primary-fixed text-on-primary-fixed px-3 py-1 rounded-full font-metadata text-metadata uppercase tracking-widest">Web3</span>
                    ...
                    <p class="font-body-md text-body-md text-on-surface-variant line-clamp-3">Most DAOs fail because they
                        try to automate human politics with smart contracts. We need a new layer of social coordination that
                        prioritizes human judgment over algorithmic execution...</p>
                    <div class="flex items-center gap-6 pt-2">
                        <button
                            class="flex items-center gap-2 font-ui-label text-ui-label text-secondary hover:text-on-surface">
        ...
        <div class="mt-section-gap text-center">
            <button
                class="border border-outline text-on-surface px-12 py-4 rounded-lg font-ui-button text-ui-button hover:bg-surface-container transition-all">Load
