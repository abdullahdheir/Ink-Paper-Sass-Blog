    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <article
            ...
            <div class="flex flex-col md:flex-row h-full">
                ...
                <div class="md:w-1/2 p-8 flex flex-col justify-between">
                    <div class="space-y-4">
                        <span class="font-metadata text-metadata text-primary uppercase tracking-wider font-bold">Featured
                            Analysis</span>
                        <h2
                        ...
                        <p class="font-body-md text-body-md text-on-surface-variant line-clamp-3">In an era of cognitive
                            overload, the design systems we build either serve the user's focus or exploit it. Exploring the
        ...
        <article
            ...
            <div class="p-6 space-y-3">
                ...
                <p class="font-metadata text-metadata text-on-surface-variant line-clamp-2">Why sketching by hand is still
