    ...
    <header class="max-w-container-max mx-auto px-gutter mb-12">
        <div class="max-w-article-max">
            ...
            <p class="font-body-lg text-body-lg text-secondary leading-relaxed">
                Exploring the intersection of aesthetics, utility, and human behavior. From the fundamentals of grid systems
                to the future of generative UI, we chronicle the evolving visual language of the digital age.
            </p>
        </div>
    </header>
                    ...
                    <article class="group cursor-pointer">
                        ...
                        <div>
                            ...
                            <p class="font-body-md text-body-md text-secondary mb-6 line-clamp-3">
                                As digital noise reaches a fever pitch, designers are looking backward to move forward.
                                Discover how the rigid grids and deliberate whitespace of mid-century print magazines are
                                reclaiming the web canvas.
                            </p>
                ...
                <section class="space-y-12">
                    ...
                    <div class="grid md:grid-cols-4 gap-8 pb-12 border-b border-outline-variant group">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <h4 class="font-body-lg text-body-lg font-bold mb-2 group-hover:text-primary transition-colors">
                    ...
                    <div class="grid md:grid-cols-4 gap-8 pb-12 border-b border-outline-variant group">
                        ...
                        <div class="md:col-span-3">
                            ...
                            <p class="font-body-md text-body-md text-secondary line-clamp-2 mb-4">Designing for focus in an
                                era of distraction requires more than just removing features; it requires a structural
                                rethink of intent.</p>
                            <div class="flex items-center gap-2">
            ...
            <aside class="md:col-span-4 space-y-12">
                <section class="sticky top-24">
                    ...
                    <div class="mt-8 p-6 bg-primary rounded-xl text-on-primary">
                        ...
                        <p class="font-body-md text-sm opacity-90 mb-4">The best of Design, delivered to your inbox every
                            Sunday morning.</p>
