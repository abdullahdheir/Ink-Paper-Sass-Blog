...
@section('page-content')
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
            ...
            <p class="text-on-surface-variant max-w-lg font-ui-label text-ui-label">Manage your intellectual output, track
    ...
    <div class="grid grid-cols-12 gap-8">
        ...
        <aside class="col-span-12 lg:col-span-3 space-y-6">
            ...
            <div class="bg-on-background text-inverse-on-surface p-6 rounded-xl border border-outline">
                ...
                <p class="text-metadata font-metadata opacity-80 leading-relaxed">Articles published on Tuesdays at 9:00 AM
                    receive 40% more engagement in the 'Paper &amp; Ink' ecosystem.</p>
            </div>
        </aside>
        <!-- Main Content Area -->
        <div class="col-span-12 lg:col-span-9 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between border-b border-outline-variant gap-4">
                <div class="flex gap-8 overflow-x-auto no-scrollbar">
                    <button
                        class="pb-4 text-ui-label font-bold border-b-2 border-primary text-primary whitespace-nowrap">Published
                        (42)</button>
                    <button
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-metadata font-ui-label font-medium text-on-surface-variant">2 articles selected</span>
                </div>
            ...
            <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-grow grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                            <div class="md:col-span-6">
                                ...
                                <p class="text-metadata font-metadata text-on-surface-variant mt-1">Published on Oct 14,
                                    2024</p>
                            </div>
                ...
                <div
                    class="bg-surface-container-lowest p-5 rounded-xl border border-outline-variant hover:border-primary transition-all group">
                    <div class="flex items-start gap-4">
                        <input checked="" class="mt-2 w-4 h-4 rounded border-outline text-primary focus:ring-primary"
                            type="checkbox" />
                        <div class="flex-grow grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                            <div class="md:col-span-6">
                                <span class="text-metadata font-metadata text-primary mb-1 block">Critique • 15 min
                                    read</span>
                                <h3
                                    class="font-headline-md text-[20px] leading-snug group-hover:text-primary transition-colors">
                                    Digital Skeuomorphism in a Flat World: A Retrospective</h3>
                                <p class="text-metadata font-metadata text-on-surface-variant mt-1">Published on Oct 09,
                                    2024</p>
                            </div>
                            <div class="md:col-span-2 flex flex-col">
                                <span class="text-metadata font-metadata text-outline">Engagement</span>
                                <div class="flex items-center gap-4 mt-1">
                                    <div class="flex items-center gap-1 text-ui-label font-medium">
                                        <span class="material-symbols-outlined text-[18px]"
                                            data-icon="visibility">visibility</span> 8.1k
                                    </div>
                                    <div class="flex items-center gap-1 text-ui-label font-medium">
                                        <span class="material-symbols-outlined text-[18px]"
                                            data-icon="chat_bubble">chat_bubble</span> 32
                                    </div>
                                </div>
                            </div>
                            <div class="md:col-span-2">
                ...
                <div
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-grow grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                            <div class="md:col-span-6">
                                <span class="text-metadata font-metadata text-primary mb-1 block">Technical • 22 min
                                    read</span>
                                <h3
                                    class="font-headline-md text-[20px] leading-snug group-hover:text-primary transition-colors">
                                    Leveraging Rust for Distributed Ledger Systems</h3>
                                <p class="text-metadata font-metadata text-on-surface-variant mt-1">Published on Sep 28,
                                    2024</p>
                            </div>
                            <div class="md:col-span-2 flex flex-col">
                                <span class="text-metadata font-metadata text-outline">Engagement</span>
                                <div class="flex items-center gap-4 mt-1">
                                    <div class="flex items-center gap-1 text-ui-label font-medium">
                                        <span class="material-symbols-outlined text-[18px]"
                                            data-icon="visibility">visibility</span> 25.0k
                                    </div>
                                    <div class="flex items-center gap-1 text-ui-label font-medium">
                                        <span class="material-symbols-outlined text-[18px]"
                                            data-icon="chat_bubble">chat_bubble</span> 210
                                    </div>
                                </div>
                            </div>
                            <div class="md:col-span-2">
            ...
            <div class="flex items-center justify-between pt-8">
                <span class="text-metadata font-metadata text-on-surface-variant">Showing 1 to 10 of 42 articles</span>
